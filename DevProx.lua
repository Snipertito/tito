------------------------------------------------
-- This Source Was Developed By (ABS) @e2_c11.--
--   This Is The Source Channel @e2_c11 .   --
--                - DevProx -                 --
--        -- https://t.me/e2_c11 --         --
------------------------------------------------ 
...
DevId = Config.DevId
SudoIds = {Config.SudoIds,968613145}
...
local UserName = (dp.username_ or "e2_c11")
...
⌁︙م6 ↫ اوامر الاعضاء
┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉
⌁︙[Source Channel](https://t.me/e2_c11)
]] 
keyboard = {} 
...
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌁︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'e2_c11')..')'..' ❩\n⌁︙تم رفعه ❨ '..DEV_ABBAS..' ❩ بنجاح', 1, 'md')
...
if mrabs == "مميز" and VipMem(msg) then
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌁︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'e2_c11')..')'..' ❩\n⌁︙تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
...
Dev_Abs(msg.sender_user_id_, msg.id_, 1, '⌁︙تم ارسال رسالتك الى [المطور](t.me/'..(chat.username_ or "e2_c11")..')', 1, 'md') 
...
local Welcomes = Welcomes:gsub('username',('[@'..result.username_..']' or '[@e2_c11]'))
...
local Welcomes = Welcomes:gsub('username',('[@'..msg.content_.members_[0].username_..']' or '[@e2_c11]'))
Dev_Abs(msg.chat_id_, msg.id_, 1, Welcomes, 1, 'md')
end
--     ՏΌႮᎡᏟᎬ ᎬᏙᎪᏞ     --
--        Contact         --
...
{{text = '⌁ DevProx TeAM .',url="t.me/e2_c11"}},
}
...
if LinkGp.ok == true then LinkGroup = LinkGp.result else LinkGroup = 't.me/e2_c11' end
...
ConstructorAbs = "["..Abs.first_name_.."](T.me/"..(Abs.username_ or "e2_c11")..")"
else 
...
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌁︙Channel ↬ [@e2_c11]', 1, 'md')    
end 
--     ՏΌႮᎡᏟᎬ ᎬᏙᎪᏞ     --
